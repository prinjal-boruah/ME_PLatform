    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('new', 'new'), ('In Progress', 'In Progress'), ('Finished', 'Finished')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comm_address1', models.CharField(max_length=150)),
                ('comm_address2', models.CharField(max_length=150)),
                ...
                ('comm_status', models.CharField(choices=[('new', 'new'), ('In Progress', 'In Progress'), ('Finished', 'Finished')], max_length=150)),
                ('comm_gstin', models.CharField(max_length=150)),
                ('bill_address1', models.CharField(max_length=150)),
                ('bill_address2', models.CharField(max_length=150)),
                ...
                ('bill_status', models.CharField(choices=[('new', 'new'), ('In Progress', 'In Progress'), ('Finished', 'Finished')], max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('new', 'new'), ('In Progress', 'In Progress'), ('Finished', 'Finished')], max_length=100)),
                ('org_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
